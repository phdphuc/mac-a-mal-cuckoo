...
class MonitorProcessLog(list):
    ...
    def __iter__(self):
        ...
        for event in self.eventstream:
            if event["type"] == "process":
                ...
                event["time"] = self.first_seen + datetime.timedelta(0, 0, event["time"])
    ...
    def __nonzero__(self):
        ...
        function of the OSXMonitor class. We use this knowledge to pass
...
class OSXMonitor(BehaviorHandler):
    """Parses monitor generated logs."""
    key = "processes"

    def __init__(self, *args, **kwargs):
        super(OSXMonitor, self).__init__(*args, **kwargs)
        self.processes = []
        self.behavior = {}
        self.reboot = {}
        self.matched = False
            ...
            # Create generic events out of the windows calls.
                ...
                for category, args in reboot.process_apicall(event):
                    ...
                    ts = process["first_seen"] + \
                        datetime.timedelta(0, 0, event["time"])
